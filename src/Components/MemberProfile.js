    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row h-screen font mt-32 overflow-y-auto">
        ...
        <div className="w-full lg:w-1/4 flex flex-col items-center p-4 mt-10">
          <div className="text-center items-center relative">
            ...
            <h2 className="text-3xl lg:text-4xl font-semibold font relative inline-flex items-center">
              John Doe
              <FontAwesomeIcon icon={faEdit}  className="ml-2  text-gray-500 cursor-pointer hover:text-gray-700" />
            </h2>
            <p className="font text-xl lg:text-2xl text-gray-600 font">john.doe@example.com</p>
          ...
          <div className="mt-6 w-full px-4 items-center text-center">
            <h3 className="font text-2xl lg:text-3xl font-semibold mb-2">Personal Info</h3>
            <p className="font text-lg lg:text-xl">Phone: (123) 456-7890</p>
            <p className="font text-lg lg:text-xl">Address: 123 Main St, Anytown, USA</p>
        ...
        <div className="w-full lg:w-3/4 p-4">
          {/* Physic Section */}
          <div className="mb-8">
            <h3 className="font text-2xl lg:text-3xl font-semibold mb-2 bg-gray-200">Physic</h3>
            <p className="font text-lg lg:text-xl">Height: 6'0"</p>
            <p className="font text-lg lg:text-xl">Weight: 180 lbs</p>
          ...
          <div className="mb-8">
            <h3 className="font text-2xl lg:text-3xl font-semibold mb-2 mt-4 bg-gray-200 ">Fitness Goals</h3>
            <p className="font text-lg lg:text-xl">Fitness Goal: Build Muscle</p>
            <p className="font text-lg lg:text-xl">Diet: Non-Vegetarian</p>
            <p className="font text-lg lg:text-xl">Ideal Weight: 170 lbs</p>
            <p className="font text-lg lg:text-xl">Preferred Exercises: Weightlifting, Cardio</p>
          </div>
          <div className="border-t border-gray-300 w-full my-4 lg:my-0"></div>

          {/* Preferences Section */}
          <div className="mb-8">
            <h3 className="font text-2xl lg:text-3xl font-semibold mb-2 mt-4 bg-gray-200">Preferences</h3>
            <p className="font text-lg lg:text-xl">Preferred Timings: Morning</p>
          ...
          <div>
            <h3 className="font text-2xl lg:text-3xl font-semibold mb-2 mt-4 bg-gray-200 ">Personal Training</h3>
            <p className="font text-lg lg:text-xl">PT: Yes</p>
            <p className="font text-lg lg:text-xl">Personal Trainer's Name: Jane Smith</p>
          </div>
        </div>
      </div>
    </>
