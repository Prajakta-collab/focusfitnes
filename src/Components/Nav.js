  ...
  return (
    ...
    >
      <nav className="max-w-[1540px] m-auto py-6 px-6 max-lg:px-12 flex justify-between items-center gap-14 max-xl:gap-5 max-sm:py-4 max-sm:px-6 relative">
        <a
          href="#home"
          className=" font-semibold text-5xl flex justify-center items-center text-white gap-1"
        >
          <img src={focuslogo} alt="logo" width={170} height={60} />
        </a>

        <ul
          className={`flex flex-1 justify-end gap-10 max-xl:gap-7 max-lg:flex-col max-lg:bg-stone-700 max-lg:text-white max-lg:pt-10 max-lg:pb-3 max-lg:px-4 max-lg:gap-4 max-lg:absolute max-lg: max-lg:top-24 max-lg:left-[5%] max-lg:w-[90%] max-lg:z-20 max-sm:top-20 ${
        ...
        <div
          className={`absolute right-[20px] translate-y-[-50%] text-2xl cursor-pointer top-[25px] ${
            openNav ? "right-[20px]" : "left-[20px]"
          }`}
